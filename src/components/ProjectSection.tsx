      ...
      <div className="bg-white rounded-lg shadow-lg overflow-hidden">
        <div className="p-4 md:p-8">
          ...
          <div className="flex flex-wrap gap-3 md:gap-4 mb-4 md:mb-6 text-xs md:text-sm">
            ...
            <div className="flex items-center gap-1 md:gap-2 text-blue-600 font-medium">
              <Award className="w-3 h-3 md:w-4 md:h-4" />
              <span>{industry}</span>
            </div>
          </div>

          <p className="text-sm md:text-base text-gray-600 mb-4 md:mb-6 leading-relaxed">{overview}</p>
